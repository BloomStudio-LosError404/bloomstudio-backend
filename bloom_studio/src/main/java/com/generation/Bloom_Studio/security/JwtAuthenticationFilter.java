...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        // 1. Verificar si hay token en el header (Debe empezar con "Bearer ")
        ...
        try {
            ...
            if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                ...
                // 4. Si el token es válido, autenticar manualmente
            ...
            // Si el token está mal formado o expirado, simplemente no autenticamos y dejamos que fluya
