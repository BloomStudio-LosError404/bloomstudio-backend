...
@CrossOrigin(
<<<<<<< HEAD:Bloom-Studio/src/main/java/com/generation/Bloom_Studio/controller/ProductController.java
        origins = "*",
=======
    origins = "*",
>>>>>>> origin/develop:bloom_studio/src/main/java/com/generation/Bloom_Studio/controller/ProductController.java
        methods = {
                RequestMethod.GET,
                RequestMethod.POST,
                RequestMethod.PUT,
